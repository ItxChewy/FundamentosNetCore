...
namespace FundamentosNetCore
{
    public partial class Form11ColeccionGrafica : Form
    {
        ...
        {
            //string elementosSeleccionado = this.lstElementos.SelectedItem.ToString();
            //this.lstElementos.Items.Remove(elementosSeleccionado);
        ...
        private void lstElementos_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                this.lblIndexSeleccionado.Text = "Index Seleccionado: "
